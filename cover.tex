...
Current theories for how we deal with volatility most rely on the equilibrium behavioral response on an experiment where some randomness is introduced.  
...
In particular, we show in psychophysical experiments that humans can follow such volatility both at the reflexive levels through their eye movements, but also at the conscious level. 
