...
\begin{figure}%[b!]
\centering{
% \includegraphics[width=\linewidth]{figures_PLoS-CB/Pasturel_etal2020_PLoS-CB-figure1}
%\begin{tikzpicture}%[thick,scale=1, every node/.style={scale=1} ]
%\node [anchor=north west] (imgA) at (0.000\linewidth,.600\linewidth){\includegraphics[width=0.325\linewidth]{figures/1_A_Experiment_randomblock.pdf}};
%\node [anchor=north west] (imgB) at (0.335\linewidth,.595\linewidth){\includegraphics[width=0.350\linewidth]{figures/1_B_protocol_recording.pdf}};
%\node [anchor=north west]  (imgC) at (0.650\linewidth,.595\linewidth){\includegraphics[width=0.350\linewidth]{figures/1_C_protocol_bet.pdf}};
...
the next section %~(\seeSec{Bayesian_change_point})
will present
...
Then, we will present %in~\seeSec{results_psycho}
...
%
% ------------------------------------------------------------------
\subsubsection*{Forgetful agent (Leaky integrator) detection model}%
% ------------------------------------------------------------------
...
% ------------------------------------------------------------------
\subsubsection*{Binary Bayesian Change-Point (BBCP) detection model}
% ------------------------------------------------------------------
...
\centering{
% \includegraphics[width=\linewidth]{figures_PLoS-CB/Pasturel_etal2020_PLoS-CB-figure3}
...
%
% ------------------------------------------------------------------
\subsubsection*{Quantitative analysis of the BBCP detection model}
% ------------------------------------------------------------------
%-------------------------------------------------------------%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Anticipatory pursuit and explicit ratings}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{sec:results_psycho}
%: FIGURE 2 fig:results_psycho~\seeFig{results_psycho}
\begin{figure}%[b!]
\centering{
% \includegraphics[width=\linewidth]{figures_PLoS-CB/Pasturel_etal2020_PLoS-CB-figure2}
%\begin{tikzpicture}
%\node [anchor=north west] (imgA) at (0.000\linewidth,1.000\linewidth){\includegraphics[width=\linewidth]{figures/2_results_enregistrement}};
%\end{tikzpicture}
}
\caption{
...
\begin{figure}%[b!]
\centering{
% \includegraphics[width=\linewidth]{figures_PLoS-CB/Pasturel_etal2020_PLoS-CB-figure4}
%\begin{tikzpicture}%[thick,scale=1, every node/.style={scale=1} ]
...
\begin{figure}%[b!]
\centering{
% \includegraphics[width=\linewidth]{figures_PLoS-CB/Pasturel_etal2020_PLoS-CB-figure5}
%\begin{tikzpicture}%[thick,scale=1, every node/.style={scale=1} ]
...
\href{https://github.com/laurentperrinet/PasturelMontagniniPerrinet2020/raw/master/Pasturel_etal2020_PLoS-CB_SI.pdf}{S1 Algorithm}. Detailed explanation of the BBCP algorithm.

\section*{Acknowledgments}
% This work was supported by EU Marie-Sk\l{}odowska-Curie Grant No 642961 (PACE-ITN) and by the Fondation pour le Recherche M\'edicale, under the program \textit{Equipe FRM} (DEQ20180339203/PredictEye/G Masson). Code and material on the \href{https://laurentperrinet.github.io/publication/pasturel-montagnini-perrinet-20}{corresponding author's website}.
