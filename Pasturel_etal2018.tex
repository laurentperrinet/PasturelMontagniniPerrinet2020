...
to anticipate random different biases
...
support a novel approach to more generically test
...
the rate increased to 4 cases per week.
...
which corresponds to a standard Smooth Pursuit Eye Movements (SPEM).
...
as a function of time by making it itself a random variable,
...
~\textbf{(A)}
This diagram represents an instance of a sequence of directions
...
the bias $p$ in target direction varies according of a piecewise-constant function
