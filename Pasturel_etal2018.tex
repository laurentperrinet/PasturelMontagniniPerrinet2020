...
%-------------------------------------------------------------%
%: >>>> LuP is here <<<<
% TODO : say here WHAT we wish to do and in the next section (contributions) HOW we do it
...
One first novelty of our study is that the variable $p$ is itself a random variable.
...
Such a sequence is presented in~\seeFig{results_psycho}, %TODO : blue line
...
To sum up, the experimental setup of the first session
