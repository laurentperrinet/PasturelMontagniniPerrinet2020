...
In a first session, participants were asked to estimate
...
In a second experimental session on the subsequent day, 
we showed the same sequence of target directions and 
we recorded particpants' eye movements~(see \seeFig{intro}-B).
...
among our $12$ participants, we show the aSPEM velocity in~\seeFig{results_psycho}
for two representative subjects throughout a sub-block of $200$ trials of the experimental sequence.
