...
for the real probability ($r = XXX \pm XXX$, $MI = XXX \pm XXX$, $p=XXX$\footnote{All following $p$-values are Wilcoxon signed-rank test.}) % https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats.wilcoxon.html
...
for the BBCP-model responses of $21$ geometrically spaced values of $h$ between $0.0025=1/400$ and $0.25=1/4$.
