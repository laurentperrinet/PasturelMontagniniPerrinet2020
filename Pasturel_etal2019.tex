...
\CP{ATTENTION le parie etait fait avant enregistrment occulaire}
...
\CP{attention il n'y a plus de ligne rouge ou noir}
...
\CP{il n'y a plus d'ombrage pour $x_1$}
...
provided by the second experiment \CP{session 1}
...
\CP{($r = 0.657$ $MI = 0.687$) pour les sujet : ($r = 0.6734 \pm 0.0797 $ $MI =  0.7079 \pm 0.1341$) notebook 4}
...
\CP{($r = 0.597$ $MI = 0.529$) pour les sujet : ($r = 0.6138 \pm 0.0698 $ $MI = 0.5622 \pm 0.1079$, $p=0.0022$ pour r et $p=0.0022$ pour MI) notebook 4}
and for that estimated by the leaky-integrator model ($r = XXX \pm XXX$, $MI = XXX \pm XXX$, $p=XXX$, see inset).
\CP{($r = 0.582$ $MI = 0.609$) pour les sujet : ($r = 0.6005 \pm 0.0790 $ $MI =  0.6221 \pm 0.1025$, $p=0.0037$ pour r et $p=0.0047$ pour MI) notebook 4}
A similar analysis
...
\CP{($r = 0.795$ $MI = 1.134$) pour les sujet : ($r = 0.8134 \pm 0.0916 $ $MI = 1.3126 \pm 0.3644$) notebook 4}
Importantly, this value is again higher for the BBCP model than
for the leaky integrator ($r = XXX \pm XXX$, $MI = XXX \pm XXX$).
\CP{($r = 0.712$ $MI = 0.968$) pour les sujet : ($r = 0.7311 \pm 0.1298 $ $MI =  1.1178 \pm 0.4092$, $p=0.0076$ pour r et $p=0.0280$ pour MI) notebook 4/
real probability : ($r = 0.679$ $MI = 0.795$) pour les sujet : ($r = 0.6949 \pm 0.0861 $ $MI =  0.9400 \pm 0.2550$, $p=0.0022$ pour r et $p=0.0022$ pour MI) }
...
\CP{les 3 valeurs de h de chaque sujets sont relier pas des ligne pointillé et les couleurs des point correspond au 3 blocs}
...
for the BBCP-model responses of $21$ geometrically spaced values of $h$ between $0.0025=1/400$ and $0.25=1/4$. \CP{1600 valeurs de $\tau$ entre 1 et 1601}
...
\CP{coefficient de correlation maximal}
