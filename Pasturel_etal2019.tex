...
is anticipatory smooth eye movements (aSPEM), 
...
Future work will be needed to address the amplitude and dynamics of modulations of visual perception and other cognitive functions in a well-controlled volatile environment like the one we formally defined in this study, and to compare it to anticipatory eye movements and explicit expectation ratings.
...
=======
\CP{certain essais ont \'etaint \'elimin\'e, soit parce-que l'enregistrement \'etait vraiment trop bruit\'e soit parce-que le fit ne coller pas bien au donn\'ee} \AM{We need to specify some numbers here: Some trials were excluded from the analysis as the proportion of missing datapoints, due to eye blinks or saccades, exceeded XX \CP{Nan supp\'erieur \`a 45ms dans le Gap, et supp\'erieur au temps total de la poursuite/3.6}. In addition, trials were also excluded when the eye-movement fitting procedure did not converge to a satisfactory match with the data (namely when the correlation was...XX \CP{ici il n'y a pas de chiffre c'\'etait fait de mani\`ere arbitraire, les essais trop bruit\'e ont aussi \'etaient \'eliminer de mani\`ere arbitraire}) }\CP{en tout il y a eu 548 essais \'elimin\'es (7,611\% des essais totals) dont 314 essais \'elimin\'es pasque trop de Nan (4,361\% des essais totals, 57,299\% des essais \'elimin\'es) et 234 essais \'elimin\'es \`a la main (3,250\% des essais totals, 42,700\% des essais \'elimin\'es)}
