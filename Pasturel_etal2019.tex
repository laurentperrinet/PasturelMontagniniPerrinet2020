...
\Cc(x_1^t, \hat{x_1}^t ) &= H(x_1^t, \hat{x_1}^t ) - H(x_1^t, x_1^t ) \text{ and } \Cc = \frac 1 T  \sum_t \Cc^t 
\label{eq:KL}
}
...
and that the distance given by~\seeEq{KL} is minimal for the true hazard rate.
