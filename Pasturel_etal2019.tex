...
%%%-------------------------------------------------------------%
%: 1Cb design of the binomial switching generative model
...
%
%: %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Results: Binomial Bayesian Change Point (BBCP) detection model}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
each of them corresponding to a binomial choice, either $0$ or $1$,
...
% ------------------------------------------------------------------
\subsection{Quantitative analysis of the Binomial Bayesian Change Point detection algorithm}
% ------------------------------------------------------------------
%-------------------------------------------------------------%
...
Let's now see the performance of our model when applied
to our behavioral experiments.
