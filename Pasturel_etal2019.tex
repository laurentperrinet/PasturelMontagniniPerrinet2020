...
Overall, the median (with $25\%$ and $75\%$ quantiles) are $h_A = 0.069 (0.038, 0.093)$ %\CP{moyenne : $0.06692999125125686 \pm 0.03628253053391533$, mediane : 0.06904761904761905 	25\% 0.038461538461538464 	75\% 0.09318181818181817} 
for the aSPEM session and
$h_R = 0.025 (0.011, 0.093)$ %\CP{moyenne : $0.06631464647744617 \pm 0.09970025861060718$, mediane : 0.02564102564102564 	25\% 0.011951909476661951 	75\% 0.09318181818181817
%} 
for the rating scale.
We observe that it is close yet higher to the (hidden) ground truth value ($h=1/40=0.025$) used to generate the sequence this value is higher for aSPEM compared to rating scale.
