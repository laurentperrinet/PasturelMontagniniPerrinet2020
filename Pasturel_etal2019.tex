...
\CP{Histogramme pour tous les sujets, et pour chaque block + ligne verticale et horizontal pointill\'e pour m\'ediane pour chaque block et pour tous}
}
...
between exploration and exploitation. } \CP{pas de correlation entre les deux sesion}
