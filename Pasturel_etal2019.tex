...
its confidence interval (respectively $.05$ and $.95$),
as represented by the shaded area surrounded by dashed lines in \seeFig{bayesianchangepoint}-B.
...
using an error plot showing the median with $.05$ and $.95$ quantiles
...
showing the median with $.05$ and $.95$ quantiles
