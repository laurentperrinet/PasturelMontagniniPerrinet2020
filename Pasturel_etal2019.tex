...
but also a volatility (as given by the probability of a new outbreak)
...
With such a three-layers structure, the model generates the randomized occurrence of the switches,
...
and that one can consider it as the average probability of change per trial.
