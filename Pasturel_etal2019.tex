...
but ignoring the variability of temporal occurrence of the switch,
...
can serve as a regressor \AM{for behavioral data}
to test whether human observers follow a similar strategy.
In particular, the free parameter $\tau$ 
...
in the data sequence, contrary to more elobarate Bayesian models~\citep{Vilares2011}.
