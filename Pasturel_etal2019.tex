...
one instance of a short sequence ($10$ trials) of simulated data $x_0^t$
of leftward and rightward trials with a switcprobability $x_1^t$
of moving rightward with possible variations across time.
