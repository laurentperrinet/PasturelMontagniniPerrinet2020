...
($P_{\text{BBCP}}$: $r = 0.6678 \pm 0.0782 $ $MI =  0.7123 \pm 0.1250$, $P_{\text{leaky}}$: $r = 0.5480 \pm 0.0749 $ with $p=0.0037$ and $MI =  0.5777 \pm 0.0961$ $p=0.0037$ ; $P_{\text{real}}$ : $r = 0.6138 \pm 0.0698 $ $p=0.0028$ -  $MI =  0.5622 \pm 0.1079$ $p=0.0022$) 
and the bet experiment 
($P_{\text{BBCP}}$: $r = 0.8027 \pm 0.0905 $ $MI =  1.2557 \pm 0.3498$, $P_{\text{leaky}}$: $r = 0.6413 \pm 0.1209$ $p=0.0028$ - $MI =  0.9666 \pm 0.3008$ $p=0.0022$ ; $P_{\text{real}}$ : $r = 0.6949 \pm 0.0861 $ $p=0.0022$ - $MI =  0.9400 \pm 0.2550$ $p=0.0022$) 
