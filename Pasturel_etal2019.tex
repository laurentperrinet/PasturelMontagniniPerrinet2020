...
From the previous study, we observed qualitatively that following a switch,
...
A possible confound in this study
...
In particular, our design will make sure that one can manipulate the probability bias
as a function of trial number by defining it as a random variable $p$. %,
