...
\node [anchor=north west]  (imgB) at (0.315\linewidth,.618\linewidth){\includegraphics[width=0.450\linewidth]{1_B_protocol_recording}};
...
\draw [anchor=north west] (0.310\linewidth, .62\linewidth) node {$\mathsf{(B)}$};
