...
In general, we found that the inference is better for the BBCP algorithm \CP{($\Cc = 0.17144731088272513 \pm 0.030868472175288958$)}
than for the leaky integrator \CP{($\Cc = 0.5225329499678493 \pm 0.12874556311723787$) notebook 3}, confirming that it provides overall a better description of the data.
