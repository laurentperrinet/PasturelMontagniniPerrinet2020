...
each individual subject are joined by dashed lines.
Dashed lines correspond to the median for the full dataset (gray line) 
...
and in general higher for eye movements.
Note that the distribution is much more narrower for the eye movement session than for the bet experiment.
Such an analysis suggests that participants may have
different mechanisms for their tendency of exploration versus exploitation
