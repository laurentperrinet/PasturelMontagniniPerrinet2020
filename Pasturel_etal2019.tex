...
we recorded participants' eye movements~(see \seeFig{intro}-B).
...
of the probability bias $P_{\mathrm{real}}$ (blue line)
...
for two representative participants throughout a sub-block of $200$ trials of the experimental sequence.
Note that these participants were chosen as those
whose fitting score corresponded to the median in the quantitative analysis
...
the real value of the hidden probability bias $x_1$ 
...
and indeed we can introduce such an assumption %in the definition of the BBCP agent, 
...
As a comparison, the same method was applied to the true value $P_{\mathrm{real}}$ and 
...
across subjects ($r = 0.8134 \pm 0.0916 $ $MI = 1.3126 \pm 0.3644$).
...
or with the real (true) probability ($r = 0.6949 \pm 0.0861 $ with $p=0.0022$ and $MI =  0.9400 \pm 0.2550$ with $p=0.0022$). % : ($r = 0.679$ $MI = 0.795$) pour les sujet -  }
...
($P_{\text{BBCP}}$: $r = 0.6678 \pm 0.0782 $ $MI =  0.7123 \pm 0.1250$, $P_{\text{leaky}}$: $r = 0.5480 \pm 0.0749 $ with $p=0.0037$ and $MI =  0.5777 \pm 0.0961$ with $p=0.0037$ ; $P_{\text{real}}$ : $r = 0.6138 \pm 0.0698 $ $p=0.0028$ and  $MI =  0.5622 \pm 0.1079$ with $p=0.0022$) 
and the bet experiment 
($P_{\text{BBCP}}$: $r = 0.8027 \pm 0.0905 $ $MI =  1.2557 \pm 0.3498$, $P_{\text{leaky}}$: $r = 0.6413 \pm 0.1209$ $p=0.0028$ and $MI =  0.9666 \pm 0.3008$ with $p=0.0022$ ; $P_{\text{real}}$ : $r = 0.6949 \pm 0.0861 $ with $p=0.0022$ and $MI =  0.9400 \pm 0.2550$ with $p=0.0022$).
...
We analyzed each participant individually by finding
