...
it is necessary to extend the experimental protocol of~\citet{Montagnini2010} in three aspects that will be illustrated in the next section.
...
the range of possible biases was finite \AM{ I WOULD SKIP THIS and 
...
First, it allows the agent to restrict the estimation $\hat{x_1}^{t+1}$ of $x_1^{t+1}$
