...
\node [anchor=north west]  (imgA) at (0.000\linewidth,.600\linewidth){\includegraphics[width=0.300\linewidth]{1_A_Experiment_randomblock}};
\node [anchor=north west]  (imgB) at (0.305\linewidth,.618\linewidth){\includegraphics[width=0.500\linewidth]{1_B_protocol_recording}};
...
\draw [anchor=north west] (0.300\linewidth, .62\linewidth) node {$\mathsf{(B)}$};
