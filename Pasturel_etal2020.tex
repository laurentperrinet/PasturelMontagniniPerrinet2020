...
% -*- coding: UTF-8; -*-
% vim: set fenc=utf-8
% https://www.biorxiv.org/content/10.1101/784116v1.full.pdf
%: %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
lead to faster and more precise responses \AM{I WOULD DELETE and,
...
and whether explicit reports of the dynamic statistical
...
such that %, knowing incoming measurements,
beliefs about latent variables
...
the likelihood of observations given the assumed generative model and
...
In such models, the comparisons between expectations and actual data leads to
...
\AM{However, %it is yet unclear what generative model to use
...
\AM{a specific random variable which fluctuates in time according to some probabilistic law.}
...
We will use that generative model as the basis for an ideal observer model \AM{equipped to
...
The comparison of human behavior with the ideal observer model's predicitons will allow us to test it as a model for the adaptation of human behavior to the environment's volatility.}
