...
Note that run-lenghts may be limited by the total number of trials $t$.
%
...
In summary, this prediction/update cycle exactly inverts the BSM generative model %~\seeEq{bsm}
