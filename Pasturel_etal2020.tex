...
For one trial block of $200$ trials, we compare the different probabilities with respect to the behavioral results.
...
the probability bias predicted with a leaky integrator ($P_{\text{leaky}}$)
...
in the middle panel of~\seeFig{results_psycho}, we show the distribution of anticipatory pursuit velocity (for details see Materials and Methods in ~\seeSec{methods})
