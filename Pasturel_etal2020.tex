...
which explicitly represent different hypotheses and how these may predict experimental measurements.
Each hypothesis defines a graph of probabilistic dependencies between specific variables 
(for instance between the number of patients at a practitionner and the reality of a flu pandemic)
