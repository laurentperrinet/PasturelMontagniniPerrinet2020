...
on the velocity of anticipatory pursuit. % (see \seeFig{intro}-B).
...
The anticipatory pursuit velocity, defined
as the horizontal best-fit eye velocity estimated right before
...
Indeed, similarly to the estimated velocity of anticipatory pursuit,
...
the amplitude of anticipatory pursuit (aSPEM) velocity, and a bet score value.
...
and in ordinate \textit{(A)} the anticipatory pursuit velocity and \textit{(B)} the bet score, respectively.
...
% and that we could represent the distribution of individual differences in the choice behavior between exploration and exploitation in both sessions for each subject 
Future work might provide important insight about the analysis of these inter-individual differences in terms of subjective preference for exploration vs exploitation across different cognitive tasks.}
