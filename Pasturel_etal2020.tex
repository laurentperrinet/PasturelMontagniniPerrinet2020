...
% R1 https://www.biorxiv.org/content/10.1101/784116v2.full.pdf
% R2-final https://www.biorxiv.org/content/10.1101/784116v3.full.pdf
...
\newcommand{\PublicationDate}{April 13, 2020}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[10pt,a4paper]{article}
\usepackage[top=0.85in,left=2.25in,footskip=0.75in]{geometry}
...
\title{\Title}%
\author{
\AuthorA\thanks{\Address},
\AuthorB\footnotemark[1],
\AuthorC\footnotemark[1] \thanks{Corresponding author: \url{\EmailC}, more information available at author's website: \url{https://laurentperrinet.github.io/publication/pasturel-montagnini-perrinet-20}.}
%\thanks{\Address}
}
