...
\CP{The top row represents the sequence of target directions (TD)
...
\CP{For all participants and for all trials, we collected an estimate of
...
\CP{We analyzed each participant's behavior individually, by searching
