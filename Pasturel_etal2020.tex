...
previous studies have used sequences of trials (\textit{trial blocks}) of fixed lengths,
...
We expect that within each of these sub-block theat we defined,
...
in one trial block of $200$ trials,
...
for two representative participants (out of $12$ participants), throughout a trial block of $200$ trials of the experimental sequence.
...
of the inferred probability bias $\hat{x_1}$ increases
in longer sub-blocks, as information is integrated over more trials.
